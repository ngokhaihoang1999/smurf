        ...
        function updateLeaderboard() {
            ...
            // Load interactive Tuner Config from localStorage if customized (Defaulted to User Tuned Specs)
            const tc = JSON.parse(localStorage.getItem('smurf_tuner_config') || 'null') || {
                ...
                t3_w: 88,  t3_a: 60, t3_x: 0, t3_y: 1
            };

            const t1Box = Math.max(tc.t1_w, tc.t1_a);
            const t2Box = Math.max(tc.t2_w, tc.t2_a);
            const t3Box = Math.max(tc.t3_w || tc.t2_w || 88, tc.t3_a || tc.t2_a || 60);
            ...
            if (stage) {
                    ...
                    html += `
                        <div onclick="openModal('${r2.smurfName.replace(/'/g, "\\'")}', this)" class="flex flex-col items-center justify-end cursor-pointer group active:scale-95 transition-all w-[110px] relative z-10">
                            ...
                            <div class="relative flex items-center justify-center aspect-square" style="width: ${t2Box}px; height: ${t2Box}px;">
                                <!-- Inner Circular Avatar with Full Card & Title Logo Visibility -->
                                <div class="rounded-full overflow-hidden shadow-sm bg-white relative z-0 aspect-square border-2 border-slate-300/80 flex items-center justify-center p-1" style="width: ${tc.t2_a}px; height: ${tc.t2_a}px;">
                                    <img src="${r2.avatar}" class="w-full h-full object-contain" onerror="this.src='avatars/smurf_basic_placeholder.png'">
                                </div>
                ...
                // Rank 1 (Gold - Center, Tallest & Crown, Shifted Slightly Right for Visual Balance)
                if (r1) {
                    html += `
                        <div onclick="openModal('${r1.smurfName.replace(/'/g, "\\'")}', this)" class="flex flex-col items-center justify-end cursor-pointer group active:scale-95 transition-all w-[130px] z-20 -mt-2 translate-x-[5px]">
                            <div class="relative flex flex-col items-center w-full">
                                ...
                                <div class="relative flex items-center justify-center aspect-square" style="width: ${t1Box}px; height: ${t1Box}px;">
                                    <!-- Inner Circular Avatar with Full Card & Title Logo Visibility -->
                                    <div class="rounded-full overflow-hidden shadow-lg ring-4 ring-amber-400/50 bg-white relative z-0 aspect-square border-2 border-amber-300 flex items-center justify-center p-1" style="width: ${tc.t1_a}px; height: ${tc.t1_a}px;">
                                        <img src="${r1.avatar}" class="w-full h-full object-contain" onerror="this.src='avatars/smurf_basic_placeholder.png'">
                                    </div>
                                    <!-- Laurel Wreath Overlay -->
                    ...
                    html += `
                        <div onclick="openModal('${r3.smurfName.replace(/'/g, "\\'")}', this)" class="flex flex-col items-center justify-end cursor-pointer group active:scale-95 transition-all w-[110px] relative z-10">
                            ...
                            <div class="relative flex items-center justify-center aspect-square" style="width: ${t3Box}px; height: ${t3Box}px;">
                                <!-- Inner Circular Avatar with Full Card & Title Logo Visibility -->
                                <div class="rounded-full overflow-hidden shadow-sm bg-white relative z-0 aspect-square border-2 border-amber-600/40 flex items-center justify-center p-1" style="width: ${a3}px; height: ${a3}px;">
                                    <img src="${r3.avatar}" class="w-full h-full object-contain" onerror="this.src='avatars/smurf_basic_placeholder.png'">
                                </div>
                                <!-- Laurel Wreath Overlay -->
